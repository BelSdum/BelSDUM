...
function renderMovies() {
    ...
    if (shuffled.length < minCards) {
        for (let i = shuffled.length; i < minCards; i++) {
            ...
            placeholder.innerHTML = `<div class="movie-card-placeholder" style="display:flex; justify-content:center; align-items:center; height:100%; color:rgba(255,255,255,0.15); font-size:15rem; font-weight:600;">Хутка</div>`;
