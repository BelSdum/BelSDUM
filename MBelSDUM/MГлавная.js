...
const movies = [
    {
        ...
        link: "Mrelease.html?id=fight_club"
    },
    {
        ...
        link: "Mrelease.html?id=No_Country_for_Old_Men"
    }
];
...
function renderContinueWatching() {
    ...
    Object.keys(savedData).forEach(id => {
        ...
        <div class="m-movie-container ${isFinished ? 'movie-finished' : ''}" data-id="${id}">
            ...
            <a href="Mplayer.html?id=${id}" class="m-click-shield"></a>
...
function renderMovieGrid() {
    ...
    shuffled.forEach(movie => {
        ...
        card.href = `Mrelease.html?id=${movie.title}`;
...
function renderFavorites() {
    ...
    <a href="Mrelease.html?id=${movie.id}" class="m-movie-card">
        <div class="m-poster-box">
